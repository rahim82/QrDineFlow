...
export const env = {
    ...
    appUrl: clean(process.env.FRONTEND_APP_URL) || clean(process.env.NEXT_PUBLIC_APP_URL) || "http://localhost:3000",
    backendUrl: clean(process.env.BACKEND_URL) || `http://localhost:${clean(process.env.PORT) || "4000"}`,
