        ...
        <main className="shell space-y-8 py-8">
            ...
            <section className="relative overflow-hidden rounded-4xl bg-stone-950 p-8 text-white shadow-[0_30px_100px_rgba(28,25,23,0.22)]">
                ...
                <div className="relative flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        <p className="text-sm uppercase tracking-[0.2em] text-orange-200">Operations center</p>
                        <h1 className="mt-2 text-4xl font-semibold tracking-tight">Live orders and analytics</h1>
                        <p className="mt-2 max-w-2xl text-stone-300">
                            Monitor active orders, review sales trends, and track table performance in one place.
                        </p>
                    </div>
                    ...
                    <div className="mt-6 space-y-4">
                        {data.orders.map((order) => (
                            <AdvancedOrderCard
                                ...
                                items={order.items}
                                splitParticipants={order.splitParticipants}
                            />
                        ))}
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    <div className="glass-card p-6">
                        ...
                        <div className="mt-4 space-y-3">
                            {data.analytics.tablePerformance.map((table) => (
                                <div
